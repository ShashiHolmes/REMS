...
<div class="row">
  <div class="leftcolumn">
    <div style="height: 423px;" class="card">
      ...
      <h5>Real Estate Management System, Nov 4, 2019</h5>
  ...
  <div class="rightcolumn">
    ...
    <div class="card">
      ...
      <p style="text-align: center;">Shashi Kumar M S<br>V sem CSE dept.</p>
    </div>
    <div class="card">
      <img src="property2/sanath.jpg" class="img">
      <p style="text-align: center;">Sanath Ramesh<br>V sem CSE dept.</p>
    </div>
  </div>
</div>

<div class="footer">
  <p style="color: #FFFFFF;">This project is done under the course Database Management System Lab<br>Computer Science and Engineering Dept.<br>National Institute of Technology Karnataka, Surathkal<br><br><i>Guided by :M Venkatesan Sir, Chaitanya Sir</i></p>
</div>
